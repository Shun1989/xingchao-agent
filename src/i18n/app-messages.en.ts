...
export const enMessages = {
  ...
  "captain.voice.welcome": "Welcome aboard. The captain is ready.",
  "captain.voice.confirmation": "Your confirmation is required before continuing.",
  "captain.voice.completion": "The task is complete.",
  "captain.voice.risk": "A risk was detected. Review it before continuing.",
  "captain.voice.manual": "The captain's status report is ready.",
  "captain.idle": "Captain standing by.",
  "captain.listening": "Listening for your next instruction.",
  "captain.thinking": "Charting the next move.",
  "captain.executing": "The crew is working.",
  "captain.reporting": "Captain reporting.",
  "captain.success": "Task complete.",
  "captain.warning": "Your confirmation is required.",
  "captain.failure": "The task needs attention.",
  "captain.host.label": "Adaptive captain",
  "captain.host.expand": "Expand captain",
  "captain.host.controls": "Captain controls",
  "captain.host.collapse": "Collapse captain",
  "captain.host.retryRenderer": "Retry captain display",
  "captain.voice.enable": "Enable captain voice",
  "captain.voice.disable": "Disable captain voice",
  "captain.voice.mute": "Mute captain voice",
  "captain.voice.manualRead": "Read captain status",
  "captain.voice.clickOnly": "Only speak when clicked",
  "captain.voice.volume": "Captain voice volume",
  "captain.voice.rate": "Captain voice rate",
  ...
  "supply.installedDescription":
    "The built-in original fleet cannot be removed. Removing a local pack requires system confirmation.",
  "supply.packCount": "{count} pack(s)",
  "supply.builtin": "Built in",
  ...
  "supply.crews": "Crews",
  "supply.agents": "Agents",
  "supply.themes": "Themes",
  ...
  "sidebar.emptyDescription": "Start a new chat above and tell Xingchao what to get done.",
  ...
  "login.title": "Welcome to Xingchao Navigation",
  ...
  "login.button": "Sign in to Xingchao Navigation",
  "login.waiting": "Waiting for Xingchao Navigation sign-in…",
